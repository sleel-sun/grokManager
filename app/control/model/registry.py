...
MODELS: tuple[ModelSpec, ...] = (
    ...
    ModelSpec("grok-composer-2.5-fast",                 ModeId.CONSOLE,  Tier.BASIC, Capability.CHAT,       True, "Grok Composer 2.5 Fast", upstream_profile="console_responses", upstream_model="grok-4.20-multi-agent", upstream_model_config_key="models.composer_fast_upstream_model", console_input_prefix="grok-composer-2.5-fast"),
