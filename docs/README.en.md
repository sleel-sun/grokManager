...
The browser-based `grok-maintainer` flow now lives inside this repository under `app/maintainer/`.
...
- Also supports `/admin/api/tokens` and `/admin/api/tokens/add`

See [app/maintainer/README.md](../app/maintainer/README.md) for details.
